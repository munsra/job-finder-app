...
import { IonHeader, IonToolbar, IonTitle, IonContent, IonButtons, IonBackButton, IonThumbnail, IonList, IonItem, IonLabel, IonChip, IonText, IonRow, IonSegment, IonSegmentButton, IonCol, IonFooter, IonButton, IonIcon } from "@ionic/angular/standalone";
...
@Component({
  ...
  standalone: true,
  imports: [IonIcon, IonButton, IonFooter, IonCol, IonSegmentButton, IonSegment, IonRow, IonText, IonChip, IonLabel, IonItem, IonList, IonBackButton, IonButtons, IonContent, IonTitle, IonToolbar, IonHeader, IonThumbnail]
})
